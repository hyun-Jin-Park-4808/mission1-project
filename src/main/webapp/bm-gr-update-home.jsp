...
<body>
	<%
	String preBmName = request.getParameter("preBmName");
	String bmNameU = request.getParameter("bmNameU");
	String bmOrderU = request.getParameter("bmOrderU");
	
	DBuse db = new DBuse();
	db.updateBmGr(preBmName, bmNameU, bmOrderU);
